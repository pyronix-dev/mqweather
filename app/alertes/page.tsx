...
function AlertesContent() {
  ...
  // State for auth & user info
  const [user, setUser] = useState<{ email: string | null, phone: string | null, full_name?: string } | null>(null)
    ...
    const checkAuth = async () => {
      try {
        ...
        if (res.ok) {
          ...
          // If checking out via "Change Plan", we might want to auto-select profile too if we had it
        }
      } catch (e) {
